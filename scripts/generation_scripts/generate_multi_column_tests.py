...
class MultiColumnTestSpecs(BaseModel):
    markdown_translation: str = Field(description="Full markdown translation of the entire page")
    texts_flowing: list[str] = Field(description="List of 1-4 texts that flow from one column to the next")
...
async def main(gt_folder: Path, save_folder: Path, start_idx: int = 0, end_idx: int = None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt_folder", type=str, default="/mnt/projects/rag-pretraitement/data/docparser/benchmarks/select_difficult_pdf/multi_column/")
    parser.add_argument("--save_folder", type=str, default="/mnt/projects/rag-pretraitement/data/docparser/benchmarks/select_difficult_pdf/tests/multi_column3")
